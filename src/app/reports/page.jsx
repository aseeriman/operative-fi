    ...
    <PageLayout title="Reports">
      <div className="p-6">
        ...
        <div className={`backdrop-blur-lg rounded-lg border overflow-hidden shadow-2xl ${
          ...
          <div className={`grid grid-cols-7 backdrop-blur-sm p-4 font-semibold border-b ${
            isDark 
                ...
                <div key={jobId} className={`border-b last:border-b-0 ${
                  ...
                  {subJobIds.map((subJobId) => {
                    ...
                    return subJobReports.map((report, index) => (
                      <div key={`${subJobId}-${index}`} className="grid grid-cols-7 p-4 items-center hover:bg-white/10 border-t border-white/10">
                        {/* Job ID */}
